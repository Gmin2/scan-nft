...
import qrlogo from '../../public/qr-code-dynamic.svg'
...
function MainContent({ openModal }: { openModal: () => void }) {
  return (
    <>
      <span>
        <Image src={qrlogo} alt="qrlogo" className="h-50 w-50 rounded" />
      </span>
      ...
      <div className='flex flex-row gap-4 items-center justify-center opacity-40'>
        ...
        <button className='border border-white rounded-2xl bg-white bg-opacity-0 hover:bg-opacity-10 cursor-not-allowed px-7 py-2 transition-all duration-200 relative flex flex-row'>
          <p className='text-white text-3xl'>Connect wallet</p>
        </button>
      </div>
    </>
  )
